...
public class EstacaoJpaController implements Serializable {
    ...
    public void create(Estacao estacao) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findEstacao(estacao.getNome()) != null) {
                throw new PreexistingEntityException("Estacao " + estacao + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
    ...
    public Estacao findEstacao(String id) {
        EntityManager em = getEntityManager();
        try {
